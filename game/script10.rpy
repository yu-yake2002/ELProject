label chapter10Start:
    "林枫答应了白芷，和她一起回到了绥化，同时以“以后再说”打发了半夏。这让半夏很不是滋味。"
    "白芷和林枫买好了机票，不过林枫察觉到事情的不对劲，于是便提前来到机场值机。"
    "林枫在QQ上告诉白芷：我已经值机完了。"
    ...
    f1 "诶？喂！"
    "林枫在机场休息室等待，实在感到无聊，便发了一条动态："
    "终于可以回家了！上次喝酒输给你们了，但是这一次我肯定会把你们喝趴下！"
    "附图为一张自己和机票的合影。"
    "此时，半夏已经在云南双柏了。她越看越不是滋味。她的本能让他给这条动态点了赞，可是随后不久又把赞取消了。"
    "白芷拿着一张票，兴致勃勃地来到了林枫面前。"
    f1 "弱诶，拜托，你很弱诶！说着不告诉我座位号，却把自己的票发在了自己的动态里让我看，没想到你还有这样的一面~"
    m1 "你，你说什么？"
    "林枫立马回去查看自己发的动态。"
    "林枫显然是太激动了，没有给自己的机票信息打上马赛克。"
    m1 "好吧，输给你了！"
    "林枫和白芷在完成一系列手续后，成功地登机。"
    m1 "飞机上有这么多座位，我怎么偏偏就和她坐在一起呢？太尴尬了啊。。。"
    "两人坐在了座位上，每个座位局促的空间让两个人的距离更近了。"
    "你去年为什么没有参加南星计划啊？怎么，南大不值得你宣传吗，看不起南大？还有，你去年这个时候怎么没回母校看一看？"
    "不会因为我是南星计划的负责人而逃避我吧！"
    "林枫彻底被这一套组合拳打蒙了，他开始思索一个能够让他保命的回答。"
    menu:
        "去年寒假很忙":
        ...
        "去年的事就让他过去吧":
            m1 "你看看，生什么气啊，我今年不是来了吗？去年的事情就让他过去吧。"
    ...
    "白芷听到这番话，虽然知道他是迫于无奈，但是心中也满是温暖。"
    "从南京到绥化的飞机只有三个小时，林枫感觉好像过了三个世纪一般。"
    jump chapter10End